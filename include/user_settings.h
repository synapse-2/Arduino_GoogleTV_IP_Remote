...
//ADDED for to get the wolfssl to compile ---- such a pain for it to work in dual framework env
    ...
    /* Consider USE_FAST_MATH and SMALL_STACK                        */
        ...
        #define ESP32_USE_RSA_PRIMITIVE
            ...
            /* See idf.py menuconfig for stack warning settings */
                    ...
                    #warning "RSA may be difficult with less than 10KB Stack -- project build"
                #endif
            #else
